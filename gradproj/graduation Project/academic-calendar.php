...
<head>
  ...
  <title> Academic Calendar | BIS</title>
</head>
...
<body>
  ...
  <div class="academicspages">
    ...
    <div class="schedule-cover academic-calendar">
      <p>Academic calendar</p>
    </div>
    <?php

$select = $bis->query("SELECT * from p47_schedules JOIN p47_scheduletype on p47_schedules.scheduleTypeId=p47_scheduletype.scheduleTypeId where `status` =1 and p47_scheduletype.scheduleTypeId=3 ORDER BY `uploadDate` DESC  ");

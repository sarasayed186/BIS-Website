...
<head>
  ...
  <title> Level One Guideline | BIS</title>
</head>
...
<body>
  ...
  <div class="academicspages">
    ...
    <div class="schedule-cover lvl1-guideline">
      <p>guideline</p>
    </div>
    <?php $select = $bis->query("SELECT * from p47_schedules JOIN p47_scheduletype on p47_schedules.scheduleTypeId=p47_scheduletype.scheduleTypeId where `status` =1 and p47_scheduletype.scheduleTypeId=5 ORDER BY `uploadDate` DESC  ");

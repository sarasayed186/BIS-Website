...
<head>
  ...
  <title> Exams Schedules | BIS</title>
</head>
...
<body>
  ...
  <div class="academicspages">
    ...
    <div class="schedule-cover exams-sechedule">
      <p>Exams Schedule</p>
    </div>

   
    <?php $select = $bis->query("SELECT * from p47_schedules JOIN p47_scheduletype on p47_schedules.scheduleTypeId=p47_scheduletype.scheduleTypeId where `status` =1 and p47_scheduletype.scheduleTypeId=2 ORDER BY `uploadDate` DESC  ");

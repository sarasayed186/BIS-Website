...
<head>
  ...
  <title> Halls Schedule | BIS</title>
</head>
...
<body>
  ...
  <div class="academicspages">
    ...
    <div class="schedule-cover halls-schedule">
      <p>halls schedule</p>
    </div>
    <?php $select = $bis->query("SELECT * from p47_schedules JOIN p47_scheduletype on p47_schedules.scheduleTypeId=p47_scheduletype.scheduleTypeId where `status` =1 and p47_scheduletype.scheduleTypeId=4 ORDER BY `uploadDate` DESC  ");

...
if (isset($_GET['delete'])) {
  $ids = $_GET['delete'];
  $delete = "DELETE FROM `p47_newsfile` WHERE id = $ids ";
...
if (isset($_POST['submit'])) {
  ...
  if (!empty($fileNames)) {
    foreach ($_FILES['files']['name'] as $key => $val) {
      ...
      if (in_array($fileType, $allowTypes)) {
        ...
        if (move_uploaded_file($_FILES["files"]["tmp_name"][$key], $targetFilePath)) {
          // Image db insert sql 
          $evid = "SELECT * from p47_news where  `newsId`=$id";
          $qq = mysqli_query($bis, $evid);
          $ew = mysqli_num_rows($qq);
          $ss = mysqli_fetch_row($qq);
          $newsId = $ss['0'];
          $insertValuesSQL .= "('" . $fileName . "', NOW(),$newsId,'$filestype'),";
        } else {
    ...
    if (!empty($insertValuesSQL)) {
      ...
      $insert = $bis->query("INSERT INTO p47_newsFile (file_name, uploade_on,newsId,filetype) VALUES $insertValuesSQL");
...
$selectname = $bis->query("select newsTitle from p47_news where newsId=$id");
    ...
    <section class="gallerys-page back">
      <div class="container-lg">
        ...
        <div class="section-title">
          <div class="n-title"><?php echo $i['newsTitle'] ?></div>
        </div>
                ...
                <div class="col">
                  <div class="card gallery-card">
                    <div class="card-image">
                      <a href="./otherphotos/<?php echo $data['file_name']; ?>" target="_blank"> <img src="./otherphotos/PDF_file_icon.svg.png" class="card-img" alt="..."></a>
                      <p><?php echo $data['file_name'] ?></p>

                    </div>
                    <form action="" method="get">
                    <a class="delete-btn btn" onclick="alert('the photo has been deleted')" href="addfiles.php?list=<?php echo $id ?>&delete=<?php echo $data['id']; ?>">Delete </a>
                ...
                <div class="col">
                  <div class="card gallery-card">
                    <div class="card-image">
                      ...
                      <img src="./otherphotos/<?php echo $data['file_name'] ?>" class="card-img" alt="...">

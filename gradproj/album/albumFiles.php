...
if (isset($_GET['delete'])) {
  $ids = $_GET['delete'];
  $delete =$bis->query( "DELETE FROM `p47_albumfile` WHERE id = $ids ");
  header("location: albumFiles.php?list=$id");
...
if (isset($_POST['submit'])) {
  ...
  $targetDir = "albumFiles/";
  $allowTypes = array('jpg', 'png', 'jpeg', 'gif', 'mp4', 'pdf', 'MP4', 'JPG', 'PNG', 'JPEG', `WEBS`);
  ...
  if (!empty($fileNames)) {
    foreach ($_FILES['files']['name'] as $key => $val) {
      ...
      if (in_array($fileType, $allowTypes)) {
        ...
        if (move_uploaded_file($_FILES["files"]["tmp_name"][$key], $targetFilePath)) {
          // Image db insert sql 
          $evid = "SELECT * from p47_album where  albumId=$id";
          $qq = mysqli_query($bis, $evid);
          $ew = mysqli_num_rows($qq);
          $ss = mysqli_fetch_row($qq);
          $albumId = $ss['0'];
          $insertValuesSQL .= "('" . $fileName . "', NOW(),$albumId,'$filestype'),";
        } else {
    ...
    if (!empty($insertValuesSQL)) {
      ...
      $insert = $bis->query("INSERT INTO p47_albumfile (file_name, uploade_on,albumId,filetype) VALUES $insertValuesSQL");
...
<head>
  ...
  <link rel="stylesheet" href="../back-gallery/fontawesome-free-5.15.4-web/css/all.css">
    ...
    <div class="container">
      <section class="gallerys-page back">
        <div class="container-lg">
          <?php $selectq = $bis->query("SELECT * from `p47_album` WHERE `albumId`=$id ");
          $i = mysqli_fetch_assoc($selectq); ?>
          <div class="section-title">
            <div class="n-title"><?php echo $i['albumTitle'] ?></div>
          </div>
                  ...
                  <div class="col">
                    <div class="card gallery-card">
                      <div class="card-image">
                        <a href="./albumFiles/<?php echo $data['file_name']; ?>" target="_blank"> <img src="./albumFiles/PDF_file_icon.svg.png" class="card-img" alt="..."></a>
                        <p><?php echo $data['file_name'] ?></p>

                      </div>
                      <form action="" method="get">
                      <a class="delete-btn btn" onclick="alert('the photo has been deleted')" href="albumFiles.php?list=<?php echo $id ?>&delete=<?php echo $data['id']; ?>">Delete </a>
                  ...
                  <div class="col">
                    <div class="card gallery-card">
                      <div class="card-image">
                        ...
                        <img src="./albumFiles/<?php echo $data['file_name'] ?>" class="card-img" alt="...">
